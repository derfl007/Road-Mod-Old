...
public class BlockRoadSignProhib10a40 extends Block{
    public BlockRoadSignProhib10a40(){
    	super(Material.WOOD);
        setUnlocalizedName("road_sign_prohib_10a_40");
        setRegistryName("BlockRoadSignProhib10a40");

...
public class BlockRoadSignProhib10b70 extends Block{
    public BlockRoadSignProhib10b70(){
    	super(Material.WOOD);
        setUnlocalizedName("road_sign_prohib_10b_70");
        setRegistryName("BlockRoadSignProhib10b70");

...
public class BlockRoadSignProhib4b extends Block{
    public BlockRoadSignProhib4b(){
    	super(Material.WOOD);
        setUnlocalizedName("road_sign_prohib_4b");
        setRegistryName("BlockRoadSignProhib4b");

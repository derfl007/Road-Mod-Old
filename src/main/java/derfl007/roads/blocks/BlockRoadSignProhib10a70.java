...
public class BlockRoadSignProhib10a70 extends Block{
    public BlockRoadSignProhib10a70(){
    	super(Material.WOOD);
        setUnlocalizedName("road_sign_prohib_10a_70");
        setRegistryName("BlockRoadSignProhib10a70");

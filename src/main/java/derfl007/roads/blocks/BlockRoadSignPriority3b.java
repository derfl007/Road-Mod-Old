...
public class BlockRoadSignPriority3b extends Block {
	public BlockRoadSignPriority3b() {
		super(Material.WOOD);
		setUnlocalizedName("road_sign_priority_3b");
		setRegistryName("BlockRoadSignPriority3b");

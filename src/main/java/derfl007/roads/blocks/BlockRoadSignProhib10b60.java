...
public class BlockRoadSignProhib10b60 extends Block{
    public BlockRoadSignProhib10b60(){
    	super(Material.WOOD);
        setUnlocalizedName("road_sign_prohib_10b_60");
        setRegistryName("BlockRoadSignProhib10b60");

...
public class BlockRoadSignProhib10b50 extends Block{
    public BlockRoadSignProhib10b50(){
    	super(Material.WOOD);
        setUnlocalizedName("road_sign_prohib_10b_50");
        setRegistryName("BlockRoadSignProhib10b50");

...
public class BlockRoadSignProhib10b20 extends Block{
    public BlockRoadSignProhib10b20(){
    	super(Material.WOOD);
        setUnlocalizedName("road_sign_prohib_10b_20");
        setRegistryName("BlockRoadSignProhib10b20");

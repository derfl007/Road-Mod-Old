...
public class BlockRoadSignProhib3c extends Block{
    public BlockRoadSignProhib3c(){
    	super(Material.WOOD);
        setUnlocalizedName("road_sign_prohib_3c");
        setRegistryName("BlockRoadSignProhib3c");

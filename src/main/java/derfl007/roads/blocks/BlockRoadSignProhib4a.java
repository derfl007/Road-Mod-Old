...
public class BlockRoadSignProhib4a extends Block{
    public BlockRoadSignProhib4a(){
    	super(Material.WOOD);
        setUnlocalizedName("road_sign_prohib_4a");
        setRegistryName("BlockRoadSignProhib4a");

...
public class BlockRoadSignPriority2 extends Block {
	public BlockRoadSignPriority2() {
		super(Material.WOOD);
		setUnlocalizedName("road_sign_priority_2");
		setRegistryName("BlockRoadSignPriority2");

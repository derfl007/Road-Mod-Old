...
public class BlockRoadSignProhib10a100 extends Block{
    public BlockRoadSignProhib10a100(){
    	super(Material.WOOD);
        setUnlocalizedName("road_sign_prohib_10a_100");
        setRegistryName("BlockRoadSignProhib10a100");

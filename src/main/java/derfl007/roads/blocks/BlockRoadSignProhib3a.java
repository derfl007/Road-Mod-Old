...
public class BlockRoadSignProhib3a extends Block{
    public BlockRoadSignProhib3a(){
    	super(Material.WOOD);
        setUnlocalizedName("road_sign_prohib_3a");
        setRegistryName("BlockRoadSignProhib3a");

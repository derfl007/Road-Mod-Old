...
public class BlockRoadSignProhib10a60 extends Block{
    public BlockRoadSignProhib10a60(){
    	super(Material.WOOD);
        setUnlocalizedName("road_sign_prohib_10a_60");
        setRegistryName("BlockRoadSignProhib10a60");

...
public class BlockRoadSignPriority3a extends Block {
	public BlockRoadSignPriority3a() {
		super(Material.WOOD);
		setUnlocalizedName("road_sign_priority_3a");
		setRegistryName("BlockRoadSignPriority3a");

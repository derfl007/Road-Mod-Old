...
public class BlockRoadSignProhib10a80 extends Block{
    public BlockRoadSignProhib10a80(){
    	super(Material.WOOD);
        setUnlocalizedName("road_sign_prohib_10a_80");
        setRegistryName("BlockRoadSignProhib10a80");

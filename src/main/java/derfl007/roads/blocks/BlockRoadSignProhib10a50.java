...
public class BlockRoadSignProhib10a50 extends Block{
    public BlockRoadSignProhib10a50(){
    	super(Material.WOOD);
        setUnlocalizedName("road_sign_prohib_10a_50");
        setRegistryName("BlockRoadSignProhib10a50");

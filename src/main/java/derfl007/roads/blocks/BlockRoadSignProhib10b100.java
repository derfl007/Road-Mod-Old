...
public class BlockRoadSignProhib10b100 extends Block{
    public BlockRoadSignProhib10b100(){
    	super(Material.WOOD);
        setUnlocalizedName("road_sign_prohib_10b_100");
        setRegistryName("BlockRoadSignProhib10b100");

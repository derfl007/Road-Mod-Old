...
public class BlockRoadSignProhib10b40 extends Block{
    public BlockRoadSignProhib10b40(){
    	super(Material.WOOD);
        setUnlocalizedName("road_sign_prohib_10b_40");
        setRegistryName("BlockRoadSignProhib10b40");

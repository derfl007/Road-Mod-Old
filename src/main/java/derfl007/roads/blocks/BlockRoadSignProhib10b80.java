...
public class BlockRoadSignProhib10b80 extends Block{
    public BlockRoadSignProhib10b80(){
    	super(Material.WOOD);
        setUnlocalizedName("road_sign_prohib_10b_80");
        setRegistryName("BlockRoadSignProhib10b80");

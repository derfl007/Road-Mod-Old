...
public class BlockRoadSignProhib10a30 extends Block{
    public BlockRoadSignProhib10a30(){
    	super(Material.WOOD);
        setUnlocalizedName("road_sign_prohib_10a_30");
        setRegistryName("BlockRoadSignProhib10a30");

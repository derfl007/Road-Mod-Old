...
public class BlockRoadSignProhib10b30 extends Block{
    public BlockRoadSignProhib10b30(){
    	super(Material.WOOD);
        setUnlocalizedName("road_sign_prohib_10b_30");
        setRegistryName("BlockRoadSignProhib10b30");

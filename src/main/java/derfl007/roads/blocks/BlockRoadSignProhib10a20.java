...
public class BlockRoadSignProhib10a20 extends Block{
    public BlockRoadSignProhib10a20(){
    	super(Material.WOOD);
        setUnlocalizedName("road_sign_prohib_10a_20");
        setRegistryName("BlockRoadSignProhib10a20");

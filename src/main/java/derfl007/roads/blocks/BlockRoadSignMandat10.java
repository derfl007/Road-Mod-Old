...
public class BlockRoadSignMandat10 extends Block {
	public BlockRoadSignMandat10() {
		super(Material.WOOD);
		setUnlocalizedName("road_sign_mandat_10");
		setRegistryName("BlockRoadSignMandat10");

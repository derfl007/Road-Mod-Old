package derfl007.roads.client.render.entity;
...
public class RenderCar<T extends EntityMinecart> extends Render<T>
{
    private static final ResourceLocation MINECART_TEXTURES = new ResourceLocation("textures/entity/minecart.png");
    
    protected ModelBase modelMinecart = new ModelMinecart();

    public RenderCar(RenderManager renderManagerIn, ModelBase modelBaseIn, float shadowSizeIn)
    {

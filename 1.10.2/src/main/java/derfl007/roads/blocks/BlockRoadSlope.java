...
public class BlockRoadSlope extends Block {
    public static final PropertyDirection FACING = BlockHorizontal.FACING;
    public static final PropertyEnum<BlockRoadSlope.EnumHalf> HALF = PropertyEnum.<BlockRoadSlope.EnumHalf>create("half", BlockRoadSlope.EnumHalf.class);
    public static final PropertyEnum<BlockRoadSlope.EnumShape> SHAPE = PropertyEnum.<BlockRoadSlope.EnumShape>create("shape", BlockRoadSlope.EnumShape.class);
    /**
     * B: .. T: xx
     * B: .. T: xx
     */
    protected static final AxisAlignedBB AABB_SLAB_TOP = new AxisAlignedBB(0.0D, 0.3125D, 0.0D, 1.0D, 0.8125D, 1.0D);
    /**
     * B: .. T: x.
     * B: .. T: x.
     */
     ...
     * B: .. T: ..
     */
    protected static final AxisAlignedBB AABB_OCT_TOP_NW = new AxisAlignedBB(0.0D, 0.3125D, 0.0D, 0.5D, 0.8125D, 0.5D);
    /**
     * B: .. T: .x
     * B: .. T: ..
     */
    protected static final AxisAlignedBB AABB_OCT_TOP_NE = new AxisAlignedBB(0.5D, 0.3125D, 0.0D, 1.0D, 0.8125D, 0.5D);
    /**
     * B: .. T: ..
     * B: .. T: x.
     */
    protected static final AxisAlignedBB AABB_OCT_TOP_SW = new AxisAlignedBB(0.0D, 0.3125D, 0.5D, 0.5D, 0.8125D, 1.0D);
    /**
     * B: .. T: ..
     * B: .. T: .x
     */
    protected static final AxisAlignedBB AABB_OCT_TOP_SE = new AxisAlignedBB(0.5D, 0.3125D, 0.5D, 1.0D, 0.8125D, 1.0D);
    /**
     * B: xx T: ..
     * B: xx T: ..
     */
     ...
     * B: x. T: ..
     */
    protected static final AxisAlignedBB AABB_QTR_BOT_WEST = new AxisAlignedBB(0.0D, -0.1875D, 0.0D, 0.5D, 0.3125D, 1.0D);
    /**
     * B: .x T: ..
     * B: .x T: ..
     */
    protected static final AxisAlignedBB AABB_QTR_BOT_EAST = new AxisAlignedBB(0.5D, -0.1875D, 0.0D, 1.0D, 0.3125D, 1.0D);
    /**
     * B: xx T: ..
     * B: .. T: ..
     */
    protected static final AxisAlignedBB AABB_QTR_BOT_NORTH = new AxisAlignedBB(0.0D, -0.1875D, 0.0D, 1.0D, 0.3125D, 0.5D);
    /**
     * B: .. T: ..
     * B: xx T: ..
     */
    protected static final AxisAlignedBB AABB_QTR_BOT_SOUTH = new AxisAlignedBB(0.0D, -0.1875D, 0.5D, 1.0D, 0.3125D, 1.0D);
    /**
     * B: x. T: ..
     * B: .. T: ..
     */
    protected static final AxisAlignedBB AABB_OCT_BOT_NW = new AxisAlignedBB(0.0D, -0.1875D, 0.0D, 0.5D, 0.3125D, 0.5D);
    /**
     * B: .x T: ..
     * B: .. T: ..
     */
    protected static final AxisAlignedBB AABB_OCT_BOT_NE = new AxisAlignedBB(0.5D, -0.1875D, 0.0D, 1.0D, 0.3125D, 0.5D);
    /**
     * B: .. T: ..
     * B: x. T: ..
     */
    protected static final AxisAlignedBB AABB_OCT_BOT_SW = new AxisAlignedBB(0.0D, -0.1875D, 0.5D, 0.5D, 0.3125D, 1.0D);
    /**
     * B: .. T: ..
     * B: .x T: ..
     */
    protected static final AxisAlignedBB AABB_OCT_BOT_SE = new AxisAlignedBB(0.5D, -0.1875D, 0.5D, 1.0D, 0.3125D, 1.0D);

    public BlockRoadSlope(String unlocalizedName, String registryName) {
        super(Material.ROCK);
    ...
    private static List<AxisAlignedBB> getCollisionBoxList(IBlockState bstate)
    {
        ...
        BlockRoadSlope.EnumShape blockstairs$enumshape = (BlockRoadSlope.EnumShape)bstate.getValue(SHAPE);
    ...
    private static AxisAlignedBB getCollEighthBlock(IBlockState bstate)
    {
        ...
        switch ((BlockRoadSlope.EnumShape)bstate.getValue(SHAPE))
        {
            case OUTER_LEFT:
            default:
    ...
    public IBlockState withMirror(IBlockState state, Mirror mirrorIn)
    {
        ...
        BlockRoadSlope.EnumShape blockstairs$enumshape = (BlockRoadSlope.EnumShape)state.getValue(SHAPE);
